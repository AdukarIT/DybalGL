...
console.log("Задание 1: Напишите функцию, которая принимает в качестве параметра номер символа в таблице Unicode. Подсчитайте количество таких символов во всех элементах массива, как в задаче 3 из первой части практики.");
function task1(Unicode) {
	let array = ['a','b','c','d','a','b','t','a'];
	let count = 0;
	...
	console.log(array);
	console.log("Количество символов '" + Unicode + "' в массиве: " + count);
}
console.log(task1(String.fromCodePoint(0x61)));


console.log("Задание 2: Напишите функцию, которая будет возвращать частичную функцию от функции из задачи 1, фиксируя искомый символ.");
// function task2() {
// 	let countOfA = task1(String.fromCodePoint(0x61));
// 	console.log(countOfA(["dad", "rod"]));
// }
// console.log(task2());


console.log("Задание 3: Отфильтруйте массив городов так, чтобы в нём остались только города из штата Калифорния, которые с 2000 по 2013 выросли в населении.");
let data = [
    {
        "city": "New York", 
...
function filterArray(city) {
	return city.state == "California" && city.growth_from_2000_to_2013 > '0';
}
var filteredArray = data.filter(filterArray);
console.log(filteredArray);


console.log("Задание 4: Подсчитайте, сколько миллионов населения живёт во всех городах на широте от 25 до 30 градусов.");
var count = 0;
for (let i = 0; i < data.length; i++) {
	if (data[i].latitude >= 25 && data[i].latitude <= 30) count += parseInt(data[i].population);
}
console.log("Людей, проживающих на широте от 25 до 35 градусов: " + count);
